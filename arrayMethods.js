...
const selection = inventors.filter(inventor => (inventor.year >= 1500 && inventor.year < 1600));
...
// 5. Sorteer de uitvinders op hoeveel jaren ze geleefd hebben, van langste leven naar kostste leven
// Verwachte uitkomst:
// [
//   { first: 'Ada', last: 'Lovelace', year: 1815, passed: 1852 },
//   { first: 'Sarah E.', last: 'Goode', year: 1855, passed: 1905 },
...
console.log(inventors.find(inventor => inventor.last === 'Edison'));
